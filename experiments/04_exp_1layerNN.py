def experiment_04():
    ...
    **Model and Set-up**
    ...
    `here`_. We exchange the gradient descent optimiser and use the Adam
    Optimizer.
    ...
    **Results**
      ...
      * Step 100, training accuracy 95.00, training loss 0.24
      * Step 200, training accuracy 99.50, training loss 0.11
      * Step 300, training accuracy 100.00, training loss 0.06
      * Step 400, training accuracy 100.00, training loss 0.04
      * Step 500, training accuracy 100.00, training loss 0.03
      * Step 600, training accuracy 100.00, training loss 0.02
